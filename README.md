...
| Path                   | Role                                                                                    |
| ---------------------- | --------------------------------------------------------------------------------------- |
| `public/`              | Web root: `index.html`, `sales-page.html`, `thankyou.html`, `cards/`, `api/reading.php` |
...
1. User completes the three-card experience on `index.html` and submits name, email, DOB, gender, and card ids/names.
