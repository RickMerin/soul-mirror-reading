...
$checkoutUrl = 'https://rebornf.pay.clickbank.net/?cbitems=smr-1&template=order-2&cbfid=63301&exitoffer=exit-1';
?>
<!DOCTYPE html>
  ...
  <div class="wrap">
    ...
    <div style="display:inline-block; background: linear-gradient(180deg, rgba(45,27,105,0.7), rgba(30,13,64,0.9)); border: 1px solid rgba(212,175,55,0.4); border-radius: 16px; padding: 20px 28px; margin: 0 auto 36px; box-shadow: 0 12px 32px rgba(0,0,0,0.4);">
      ...
      <div style="display:flex; align-items:center; justify-content:center; gap:14px;">
        <div style="text-align:center;">
          <div id="countdownMinutes" style="font-family:'Cormorant Garamond',serif; font-size:48px; font-weight:600; color:var(--gold-light); line-height:1; min-width:80px; padding:8px 14px; background: rgba(255,255,255,0.04); border-radius: 10px;">43</div>
        ...
        <div style="text-align:center;">
          <div id="countdownSeconds" style="font-family:'Cormorant Garamond',serif; font-size:48px; font-weight:600; color:var(--gold-light); line-height:1; min-width:80px; padding:8px 14px; background: rgba(255,255,255,0.04); border-radius: 10px;">58</div>
