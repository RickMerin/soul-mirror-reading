...
<body>
  ...
  <?php if (in_array(($funnelBase ?? ''), ['', 'wealth/', 'wealth-v2/', 'wealth-direct/', 'love/', 'love-v2/'], true)): ?>
  <!-- root + wealth + wealth-v2 + love + love-v2: hide the page header (eyebrow + headline + subhead) once the visitor picks their first card -->
  <script>
    (function () {
