...
$cssPath = __DIR__ . '/assets/thankyou-bundle.min.css';
$cssVer = is_file($cssPath) ? filemtime($cssPath) : time();
$jsPath = __DIR__ . '/assets/thankyou.min.js';
...
<body>
  ...
  <script defer src="assets/thankyou.min.js?v=<?= htmlspecialchars((string) $jsVer, ENT_QUOTES) ?>"></script>
</body>
