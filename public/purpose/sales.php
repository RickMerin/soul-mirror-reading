...
$checkoutUrl = 'https://rebornf.pay.clickbank.net/?cbitems=smr-1-p&template=order-3&cbfid=63301&exitoffer=exit-1';
...
$pageTitle = 'Your Soul Mirror Reading. What the Cards Are Really Saying';
?>
<!DOCTYPE html>
<html lang="en" data-funnel-base="purpose/">
...
<!-- TOP NOTICE BAR -->
<div class="topnotice">
  <strong><span class="firstname">Friend</span>, Your Soul Tarot Reading Is On Its Way</strong><span class="notice-dot">&middot;</span><strong>The Purpose Block Is the Root of the Other Two</strong><span class="notice-dot">&middot;</span><strong>Read This Before Your Reading Lands.</strong>
</div>
...
<section class="vsl-section">
  <div class="wrap">
    <h1 class="vsl-headline">The Purpose Block Is the Root.<br><em>Clear It, and the Other Two Balance.</em></h1>
    <p class="vsl-sub">The same belief that has you starting things you never finish, taking roles that look right but feel hollow, and asking the same question at 45 you were asking at 25, that belief is also the one quietly capping your money and dimming your relationships. Your three cards have already named it. We call it <strong>your Mirror Block</strong>, and once it has a name, it loses most of its power.</p>
    <p class="vsl-sub" style="margin-top:-8px;"><em>Watch what your cards just revealed.<br>This is the part most life coaches never tell you.</em></p>

    <div class="video-frame">
      <vturb-smartplayer id="vid-6a03e48213e119642182af7b"
        style="display: block; margin: 0 auto; width: 100%;"
        data-autoplay="false" autoplay="false" muted="false"></vturb-smartplayer>
      <script type="text/javascript">
  ...
  <div class="wrap">
    ...
    <div class="three-cards">
      ...
      <div class="card-mirror" data-card-slot="life">
        ...
        <p>Where the restless searching lives. The career you keep almost-but-not-quite landing in. The project you start, set down, and circle back to two years later, still unfinished.</p>
      </div>
...
<section class="section" style="position:relative;">
  <div class="wrap">
    ...
    <p style="text-align:center; max-width:600px; margin:0 auto 18px;">Your three cards point to one specific belief at the root of your sense of purpose. The same belief quietly shapes the income you stop just short of, and the closeness you keep at arm's length with the people you love most. Name it at the purpose root. Watch all three balance back.</p>
    ...
    <div class="block-reveal-wrapper" style="max-width:560px; margin:16px auto 0; position:relative; cursor:pointer;">
      <div class="block-reveal-content" style="background: linear-gradient(180deg, rgba(45,27,105,0.6), rgba(30,13,64,0.9)); border: 1px solid var(--gold); border-radius: 14px; padding: 28px 26px; box-shadow: 0 12px 32px rgba(0,0,0,0.3); text-align: center;">
        ...
        <h4 data-mirror-block-name style="font-family:'Cormorant Garamond',serif; font-size:26px; color:#fff; font-weight:600; margin-bottom:14px; line-height:1.25;">Your Purpose Is Blocked</h4>
        <p data-mirror-block-summary style="font-size:16px; color:rgba(255,255,255,0.85); line-height:1.7; margin:0; font-style:italic;">Clarity arrives. Clarity quietly fades. The same restless search, the same unfinished thing, year after year, no matter how many fresh starts you take.</p>
      </div>
    ...
    <p style="text-align:center; max-width:600px; margin:32px auto 0; font-style:italic; color:rgba(255,255,255,0.75); font-size:15px;">Your reading walks you through what this pattern has been doing in your sense of purpose first, then in your money and your relationships, and gives you the practice to begin clearing it.</p>
  ...
  <div class="wrap">
    <div class="vip-box">
      ...
      <ul class="vip-list">
        ...
        <li><span><strong>Life Mirror Deep-Dive.</strong> Why the same restless searching keeps repeating, why the work that should fit never quite does, and the exact place the loop closes on itself.</span></li>
...
<section style="padding: 60px 24px 40px; text-align:center; position:relative;">
  <div class="wrap">
    ...
    <div style="text-align:center; margin-top:24px;">
      <a href="<?= htmlspecialchars((string) $checkoutUrl, ENT_QUOTES) ?>" class="cta">See My Mirror Block &middot; $37 →</a>
      <div class="cta-trust-row" style="margin-top:16px;">
...
<section class="section">
  <div class="wrap">
    ...
    <div class="testi-card">
      ...
      <div class="testi-stars">★ ★ ★ ★ ★</div>
      <p class="testi-body">"I have had tarot readings for twenty years and always felt something was missing. This one gave me the piece. The Mirror Block Luna named was the same reason I had quit four careers in twelve years and the same reason I had never finished the book I had been writing since I was thirty-two. One belief. Three rooms of my life. I cried reading it, in the best possible way. Six weeks later I sat down and wrote the last chapter."</p>
    </div>
  ...
  <div class="wrap">
    ...
    <div style="display:grid; grid-template-columns:1fr 1fr; gap:20px; margin-top:32px;">
      ...
      <div style="background: linear-gradient(180deg, rgba(45,27,105,0.6), rgba(30,13,64,0.85)); border: 1px solid rgba(212,175,55,0.45); border-radius: 14px; padding: 28px 22px; backdrop-filter: blur(4px);">
        ...
        <p style="font-size:15px; color:rgba(255,255,255,0.85); line-height:1.7; margin:0;">Within 24 hours, your Soul Mirror Reading lands in your inbox. You read it once on your couch. The next morning you read it again, slower. You see the single belief that has been running underneath every fresh start, every almost-right role, and every quiet pull-back in your closest relationships. The work begins from there. Most people tell me it takes 21 days before they notice they have stopped doing the thing they have been doing for years.</p>
      </div>
      <!-- Path B -->
      <div style="background: rgba(255,255,255,0.04); border: 1px solid rgba(255,255,255,0.12); border-radius: 14px; padding: 28px 22px; backdrop-filter: blur(4px);">
        ...
        <p style="font-size:15px; color:rgba(255,255,255,0.6); line-height:1.7; margin:0;">You close this page. You finish your tea. The pattern keeps running. Six months from now you are back here. Or four months into a fresh start that already feels like the last one, asking the same question you have been asking since your twenties. The cards you chose minutes ago will not carry the same precision a week from now. The window narrows quietly.</p>
      </div>
    </div>
...
<section style="padding: 0 24px 60px;">
  <div class="final-cta">
    ...
    <p style="max-width:560px; margin:18px auto 24px; color:rgba(255,255,255,0.85);">The pattern is already there. It has been costing you the work that would feel like yours, the closeness you have kept just out of reach, and the income you stop just short of, year after year. The only question is whether you let another year pass without seeing it clearly.</p>
