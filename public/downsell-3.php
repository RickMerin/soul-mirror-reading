...
<body>
  ...
  <!-- 1. NOTICE BAR -->
  <div class="topnotice">
    <strong>Wait, One Moment</strong> <span class="dot">&middot;</span> <strong>Before Your Order Is Complete</strong> <span class="dot">&middot;</span> <strong>A One-Time Adjustment</strong>
  </div>
  ...
  <main>
    ...
    <section class="section center">
      <div class="wrap">
        ...
        <p class="subhead hero-sub">I do not want twenty dollars to keep us apart. Your first month of The Inner Circle is now just $17, not $37. You still get every perk: unlimited private 1-1 sessions with me, a reply within the hour, all of it. Then just $19/month, cancel anytime.</p>
      </div>
    </section>
      ...
      <div class="wrap" style="max-width:620px;">
        <div class="offer-box">
          ...
          <div class="founding-panel">
            ...
            <p>Your <strong>first month is $17</strong>. After that it is <strong>$19/month for unlimited sessions</strong>, and your founding rate is locked for as long as you stay.</p>
          </div>

          <div class="pricing">
            <span class="price-label">Founding Member Price</span>
            <div class="price-row">
              <span class="price-old">$37</span>
              <span class="price-new"><span class="cur">$</span>17</span>
            </div>
            <p class="price-note">Was $120 per session. For your first month, then $19/month for unlimited sessions, locked</p>
          </div>
