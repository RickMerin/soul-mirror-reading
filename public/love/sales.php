...
<!-- TOP NOTICE BAR -->
<div class="topnotice">
  <strong><span class="firstname">Friend</span>, Your Soul Tarot Reading Is On Its Way</strong><span class="notice-dot">&middot;</span><strong>The Love Block Is the Root of the Other Two</strong><span class="notice-dot">&middot;</span><strong>Read This Before Your Reading Lands.</strong>
</div>
...
<section class="vsl-section">
  <div class="wrap">
    <h1 class="vsl-headline">The Love Block Is the Root.<br><em>Clear It, and the Other Two Balance.</em></h1>
    <p class="vsl-sub">The same belief that has you pulling back at three months, going quiet at six, ending it the moment it could become real, that belief is also the one quietly capping your money and dulling your sense of purpose. Your three cards have already named it. We call it <strong>your Mirror Block</strong>, and once it has a name, it loses most of its power.</p>
    <p class="vsl-sub" style="margin-top:-8px;"><em>Watch what your cards just revealed.<br>This is the part most love coaches never tell you.</em></p>
  ...
  <div class="wrap">
    ...
    <div class="three-cards">
      <div class="card-mirror" data-card-slot="love">
        ...
        <p>Where you pull back the moment connection becomes real. The exact pattern behind the texts that go unanswered, the third date that never happens, and the relationship that ends the same way it always does.</p>
      </div>
...
<section class="section" style="position:relative;">
  <div class="wrap">
    ...
    <p style="text-align:center; max-width:600px; margin:0 auto 18px;">Your three cards point to one specific belief at the root of your love life. The same belief quietly shapes what you let yourself receive at work, and what you let yourself want from a life that is actually yours. Name it at the love root. Watch all three balance back.</p>
    ...
    <div class="block-reveal-wrapper" style="max-width:560px; margin:16px auto 0; position:relative; cursor:pointer;">
      <div class="block-reveal-content" style="background: linear-gradient(180deg, rgba(45,27,105,0.6), rgba(30,13,64,0.9)); border: 1px solid var(--gold); border-radius: 14px; padding: 28px 26px; box-shadow: 0 12px 32px rgba(0,0,0,0.3); text-align: center;">
        ...
        <h4 data-mirror-block-name style="font-family:'Cormorant Garamond',serif; font-size:26px; color:#fff; font-weight:600; margin-bottom:14px; line-height:1.25;">Your Love Is Blocked</h4>
        <p data-mirror-block-summary style="font-size:16px; color:rgba(255,255,255,0.85); line-height:1.7; margin:0; font-style:italic;">Love arrives. Love quietly slips. The same almost, the same not-quite, partner after partner, no matter how different they look on paper.</p>
      </div>
    ...
    <p style="text-align:center; max-width:600px; margin:32px auto 0; font-style:italic; color:rgba(255,255,255,0.75); font-size:15px;">Your reading walks you through what this pattern has been doing in your love life first, then in your money and your sense of purpose, and gives you the practice to begin clearing it.</p>
  ...
  <div class="wrap">
    <div class="vip-box">
      ...
      <ul class="vip-list">
        ...
        <li><span><strong>Love Mirror Deep-Dive.</strong> Why the same near-miss keeps repeating in relationship after relationship, and the exact moment your pattern fires.</span></li>
...
<section class="section">
  <div class="wrap">
    ...
    <div class="testi-card">
      ...
      <div class="testi-stars">★ ★ ★ ★ ★</div>
      <p class="testi-body">"I have had tarot readings for twenty years and always felt something was missing. This one gave me the piece. The Mirror Block Luna named was the same reason I had been ending every relationship right before it got real and the same reason I had been silent at work for a decade. One belief. Three rooms of my life. I cried reading it, in the best possible way. Six weeks later I let my partner stay the night without scanning for his exit."</p>
    </div>
  ...
  <div class="wrap">
    ...
    <div style="display:grid; grid-template-columns:1fr 1fr; gap:20px; margin-top:32px;">
      ...
      <div style="background: linear-gradient(180deg, rgba(45,27,105,0.6), rgba(30,13,64,0.85)); border: 1px solid rgba(212,175,55,0.45); border-radius: 14px; padding: 28px 22px; backdrop-filter: blur(4px);">
        ...
        <p style="font-size:15px; color:rgba(255,255,255,0.85); line-height:1.7; margin:0;">Within 24 hours, your Soul Mirror Reading lands in your inbox. You read it once on your couch. The next morning you read it again, slower. You see the single belief that has been running underneath every quiet pull-back at month three, every conversation you swerve, and every relationship that ends the same way. The work begins from there. Most people tell me it takes 21 days before they notice they have stopped doing the thing they have been doing for years.</p>
      </div>
      <!-- Path B -->
      <div style="background: rgba(255,255,255,0.04); border: 1px solid rgba(255,255,255,0.12); border-radius: 14px; padding: 28px 22px; backdrop-filter: blur(4px);">
        ...
        <p style="font-size:15px; color:rgba(255,255,255,0.6); line-height:1.7; margin:0;">You close this page. You finish your tea. The pattern keeps running. Six months from now you are back here. Or sitting across from someone new who looks different but feels exactly the same, watching the third date go quiet for reasons you cannot name. The cards you chose minutes ago will not carry the same precision a week from now. The window narrows quietly.</p>
      </div>
    </div>
...
<section style="padding: 0 24px 60px;">
  <div class="final-cta">
    ...
    <p style="max-width:560px; margin:18px auto 24px; color:rgba(255,255,255,0.85);">The pattern is already there. It has been costing you the love that has been waiting for you, the money you have been quietly leaving on the table, and the version of your life that has felt almost within reach for years. The only question is whether you let another year pass without seeing it clearly.</p>
