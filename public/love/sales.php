...
$checkoutUrl = "https://rebornf.pay.clickbank.net/?cbitems=smr-1-l&template=order-4&cbfid=63566&exitoffer=exit-4&vtid=[cmc_vid]";
?>
...
<p style="text-align:center; max-width:600px; margin:0 auto 18px;">Apart, each card is just interesting. Together, they name the one belief keeping love at arm's length, the same belief quietly shaping your money and purpose too. Name it once, and all three move.</p>

    <p style="text-align:center; max-width:600px; margin:0 auto 36px;">Not a horoscope. It reads the <strong style="color:var(--gold-light);">three cards you drew</strong> as one connected system: the exact reason the right love keeps almost arriving, then slipping away. Never a script.</p>
    ...
    <div style="max-width:560px; margin:16px auto 0;">
      <div style="background: linear-gradient(180deg, rgba(45,27,105,0.65), rgba(30,13,64,0.92)); border: 1px solid var(--gold); border-radius: 14px; padding: 32px 28px; box-shadow: 0 16px 40px rgba(0,0,0,0.35); text-align: center;">
        ...
        <p data-mirror-block-summary style="font-size:18px; color:rgba(255,255,255,0.85); line-height:1.7; margin:0 0 20px; font-style:italic;">The right love comes close, then quietly slips away, or you brace and hold it back. The same near-miss, no matter who it is. It was never you. It is this.</p>
        <div style="border-top:1px solid rgba(212,175,55,0.25); padding-top:18px; font-size:18px; color:rgba(255,255,255,0.78); line-height:1.6;">Your reading shows you <strong style="color:var(--gold-light);">exactly how</strong> your Love Block works, and the one practice that clears it. Not more apps. Not another book. One quiet shift, and the love that kept slipping past finally has room to <strong style="color:var(--gold-light);">stay</strong>.</div>
      </div>
    </div>
    ...
    <div style="max-width:520px; margin:26px auto 0; text-align:center;">
      ...
      <div style="display:grid; gap:9px; justify-items:center;">
        <p style="margin:0; font-size:16px; color:rgba(255,255,255,0.9); line-height:1.5;"><span style="color:var(--gold-light); font-weight:700;">&#10003;</span> The closeness that used to make you brace starts to feel safe.</p>
        <p style="margin:0; font-size:16px; color:rgba(255,255,255,0.9); line-height:1.5;"><span style="color:var(--gold-light); font-weight:700;">&#10003;</span> The near-misses stop repeating.</p>
        <p style="margin:0; font-size:16px; color:rgba(255,255,255,0.9); line-height:1.5;"><span style="color:var(--gold-light); font-weight:700;">&#10003;</span> The love that kept slipping past finds room to stay.</p>
      </div>
  ...
  <div class="wrap">
    ...
    <div style="display:grid; grid-template-columns:1fr 1fr; gap:20px; margin-top:32px;">
      ...
      <div style="background: linear-gradient(180deg, rgba(45,27,105,0.6), rgba(30,13,64,0.85)); border: 1px solid rgba(212,175,55,0.45); border-radius: 14px; padding: 28px 22px; backdrop-filter: blur(4px);">
        ...
        <p style="font-size:18px; color:rgba(255,255,255,0.85); line-height:1.7; margin:0;">Within 24 hours, your Soul Mirror Reading lands in your inbox. You read it once, then again the next morning, slower. You see the single belief that kept the right love almost arriving and then slipping away, that drew you to the unavailable and made you go cold first. Most people say that within 21 days, they stop bracing the moment love gets close, and start seeing the steady ones they used to overlook.</p>
      </div>
      <!-- Path B -->
      <div style="background: rgba(255,255,255,0.04); border: 1px solid rgba(255,255,255,0.12); border-radius: 14px; padding: 28px 22px; backdrop-filter: blur(4px);">
        ...
        <p style="font-size:18px; color:rgba(255,255,255,0.6); line-height:1.7; margin:0;">You close this page. You finish your tea. The block keeps running. Six months from now, you are back here, watching the closeness pull away from someone new, or overlooking the person right in front of you. The same wall in different paint. The cards you drew today will not read the same a week from now.</p>
      </div>
    </div>
