...
<head>
  ...
  <!-- Upsell 2 - Love Clarity Ritual v2 (wealth-v2 cosmic system) -->
  <title>Clear the Other Two Mirrors, The Love Clarity Ritual From Luna Ross</title>
...
<body>
  ...
  <!-- NOTICE BAR -->
  <div class="topnotice">
    <strong>Hold On, One Mirror Is Still Clouded</strong><span class="dot">&middot;</span><strong>Your Love &amp; Purpose Mirrors Just Unlocked</strong><span class="dot">&middot;</span><strong>$100 Off, This Page Only</strong>
  </div>
  ...
  <main>
    ...
    <section class="section center">
      <div class="wrap">
        ...
        <p class="subhead">One block runs <strong style="color:var(--gold-light);font-style:normal;">all three</strong> mirrors. Clearing money loosens the others slowly. This clears love and purpose now.</p>
        <div class="part-grid">
    ...
    <section class="section">
      <div class="wrap">
        <h2>Three Movements.<br /><em>The Block, Cleared in Love and Purpose.</em></h2>
        <p class="subhead">Not another reading. You already know love and purpose feel off, so this skips the diagnosis and goes straight to the clearing.</p>
        <hr class="gold-rule" style="margin-top:34px;" />
        <div class="stack">
          <div class="card mv">
            <div class="mv__num">Movement One</div>
            <div class="mv__body"><h3>The Pattern in Love</h3><p>See the exact move your block makes the second love gets close: the pull-back, the test, the bracing. Named precisely, so you can catch it instead of living it.</p></div>
          </div>
          <div class="card mv">
            <div class="mv__num">Movement Two</div>
            <div class="mv__body"><h3>The Clearing</h3><p>The sequence that releases the guard around receiving, so closeness stops registering as a risk. This is the part that loosens the bracing.</p></div>
          </div>
          <div class="card mv">
    ...
    <section class="section">
      <div class="wrap">
        <span class="eyebrow">✦ Included With The Love Clarity Ritual ✦</span>
        <h2>Three Bonuses to <em>Carry It Into Purpose</em></h2>
        <p class="subhead">Love is one mirror. These take the same clearing into your purpose and keep both clear day to day.</p>
    ...
    <section class="section">
      <div class="wrap">
        <h2>I Cleared the Money Mirror First, Too.<br /><em>Then I Found the Other Two.</em></h2>
        <div class="card luna-card">
          <div class="body-copy">
            <p>When I finally moved my own money ceiling, I thought the work was done. It was not. Months later I was still bracing every time something good happened, still circling work I never let myself claim. <strong>Same block, different mirror.</strong></p>
            <p>Given enough time, the money work alone would have softened them. I did not want to wait years. So I built the clearing for love and purpose the same way: written, step by step. I have now walked thousands through clearing all three. <strong>This is the half that makes a whole life feel different, not just a fuller bank account.</strong></p>
          </div>
    ...
    <section class="section">
      <div class="wrap">
        ...
        <h2>They Did the Money Work.<br /><em>Then the Other Two Mirrors Cleared.</em></h2>
        <div style="margin-top:26px;">
          <div class="testi">
            ...
            <p class="testi__body">"I almost skipped this. Three weeks in, I stopped waiting for my marriage to fall apart. I did not realise I had been doing that for years until it stopped."</p>
          </div>
          <div class="testi">
            <div class="testi__row">
          ...
          <div class="testi">
            ...
            <div class="testi__stars">&#9733;&#9733;&#9733;&#9733;&#9733;</div>
            <p class="testi__body">"I bought it sceptical. The Pattern in Love movement showed me the exact second I push people away. Last week I caught myself, and for the first time I did not. Worth it on its own."</p>
          </div>
        </div>
        <p style="text-align:center;max-width:620px;margin:18px auto 0;font-size:13px;color:#9a93b3;font-style:italic;">Individual results vary and are not typical. The Love Clarity Ritual is a self-guided practice, not relationship or medical advice.</p>
      </div>
    </section>
    ...
    <section class="section--tight center">
      <div class="wrap" style="max-width:640px;">
        ...
        <p style="color:var(--text-muted);font-size:16px;line-height:1.7;max-width:560px;margin:0 auto;">The $67 member rate shows once, here, then returns to $167. And every month your money work takes to reach love and purpose is another month of the old reflex running. This is the page that skips the wait.</p>
      </div>
    </section>
  ...
  <footer class="footer">
    ...
    <p>The Love Clarity Ritual is a self-guided written practice. Results may vary and are not typical. This is not relationship advice and is not a substitute for licensed mental health care.</p>
