...
$otoCheckoutUrl = 'https://rebornf.pay.clickbank.net/?cbitems=srp-1-v2&cbur=a&vtid=[cmc_vid]';
$downsellPageUrl = 'https://rebornf.pay.clickbank.net/?cbitems=srp-1-v2&cbur=d&vtid=[cmc_vid]';
    ...
    <section class="section">
      <div class="wrap">
        <div class="guarantee">
          ...
          <p>Open the three rituals, follow them in order, and give them a real 90 days. If at any point in those 90 days your money ceiling has not budged, or you simply feel it was not for you, reply and I refund every cent of your $67. No questionnaire, no proof, no explaining yourself; your word is enough. You keep the rituals, the workbook, and all three bonuses no matter what. The only way you lose here is by never opening them.</p>
        </div>
      </div>
    </section>
