<?php
/**
 * Soul Mirror Reading , Downsell 1-ds2 (FINAL OFFER $47 on the wealth ritual, short, wealth-v2 design system)
 * Offer:    Soul Ritual Practice , $67 (downsell-1) declined -> $47 FINAL one-time downsell
 * ClickBank: item PLACEHOLDER srp-1-ds2 (CONFIRM/CREATE the $47 item before deploy)
  ...
  <main id="main-content">
    ...
    <section style="padding:8px 24px 44px;" id="offer">
      <div class="pricing-block" style="border-color:rgba(212,175,55,.85); box-shadow:0 0 34px rgba(212,175,55,.3);">
        ...
        <a href="https://rebornf.pay.clickbank.net/?cbitems=srp-1-l-ds2&amp;cbur=a" class="cta" style="margin-top:22px;">Yes, I Will Take the Final Offer &middot; $37 &rarr;</a>
        <div class="cta-trust-row" style="margin-top:16px;">
          <span>&#128274; Secure Checkout</span>
          <span>&#9889; Delivered Immediately</span>
          <span>&#127769; 90-Day Guarantee</span>
        </div>
        <a class="ds-decline" href="https://rebornf.pay.clickbank.net/?cbitems=srp-1-l-ds2&amp;cbur=d">No thank you, take me to my reading</a>
